    ...
    <header class="header-v4">
		...
		<div class="container-menu-desktop">
			...
			@endphp
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="{{ $currentRoute == '/' ? 'active-menu' : '' }}">
								<a href="{{ url('/') }}">Home</a>
							</li>
							<li class="{{ $currentRoute == 'Shop' ? 'active-menu' : '' }}">
								<a href="{{ url('/Shop') }}">Shop</a>
							</li>
							<li class="{{ $currentRoute == 'Blog' ? 'active-menu' : '' }}">
								<a href="{{ url('/Blog') }}">Blog</a>
							</li>
							<li class="{{ $currentRoute == 'About' ? 'active-menu' : '' }}">
